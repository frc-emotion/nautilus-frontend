  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'DEFAULT': '0 2px 8px 0 rgba(0, 0, 0, 0.08), 0 4px 12px 0 rgba(0, 0, 0, 0.04)',
        'md': '0 4px 16px 0 rgba(0, 0, 0, 0.12), 0 2px 6px 0 rgba(0, 0, 0, 0.08)',
        'lg': '0 8px 24px 0 rgba(0, 0, 0, 0.16), 0 4px 12px 0 rgba(0, 0, 0, 0.08)',
        'xl': '0 12px 32px 0 rgba(0, 0, 0, 0.20), 0 8px 16px 0 rgba(0, 0, 0, 0.08)',
        '2xl': '0 20px 48px 0 rgba(0, 0, 0, 0.24), 0 12px 24px 0 rgba(0, 0, 0, 0.12)',
